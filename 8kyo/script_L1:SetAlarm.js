/*
    ...
    two parameters. The first parameter, employed,
    is true whenever you are employed and the second
    parameter, vacation is true whenever you are on vacation.

    The function should return true if you are employed
    and not on vacation (because these are the
...
function setAlarm(employed,vacation) {
    if ((employed === true) && (vacation === true)) {
        ...
        return false;
    } else return !((employed === false) && (vacation === false));
}